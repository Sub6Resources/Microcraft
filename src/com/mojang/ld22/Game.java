...
/*  37 */   private Bitmap image = new Bitmap(160, 120, 1);
/*  38 */   private int[] pixels = this.image.getRaster().getDataBuffer().getData();
...
/*     */     try
/*     */     {
/* 118 */       this.screen = new Screen(160, 120, new SpriteSheet(BitmapFactory.decodeStream(Game.class.getResourceAsStream("/icons.png"))));
/* 119 */       this.lightScreen = new Screen(160, 120, new SpriteSheet(BitmapFactory.decodeStream(Game.class.getResourceAsStream("/icons.png"))));
/*     */     } catch (IOException e) {
